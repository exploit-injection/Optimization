...
def Ovr():
    ...
    t1 = 0.001  # шаг 1-го этапа
    t2 = 0.005  # шаг 2-го этапа
    e1 = 2000  # для проверки условий на 1-ом этапе
    e2 = 1000  # для проверки условий на 2-ом этапе
    epsilon = 0.001
    ...
    iteration_all = 0  # для подсчета кол-ва циклов
    ...
    while abs(stop[0]) > epsilon and abs(stop[1]) > epsilon and N_all != 0:
        ...
        print("1 Этап")
        N1 = 10  # кол-во итераций для 1-го этапа
        N2 = 7  # кол-во итераций для 2-го этапа
